    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="py-5 text-center">
                <h2>Files Encryption Page</h2>
                <p class="lead">Below is an example form built for encrypting PNG files.</p>
            </div>
            ...
            <div class="row ml-2 py-5" id="p-text-rearrange" style="display: none">
                <div class="col-md-8 order-md-1">
                    <blockquote class="mint">
                        <h5>Rearranged <span class="Cmint">P-Text </span> successfully finished:</h5>
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#programs').append('<div class="row">\n' +
                        '        <div class="col-md-12 order-md-1">' +
                        '<ul class="list-group">\n' +
                        '  <li class="list-group-item"><a href='+jsonData[0]+' id="download" download>Download Program 0</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[1]+' id="download" download>Download Program 1</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[2]+' id="download" download>Download Program 2</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[3]+' id="download" download>Download Program 3</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[4]+' id="download" download>Download Program 4</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[5]+' id="download" download>Download Program 5</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[6]+' id="download" download>Download Program 6</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[7]+' id="download" download>Download Program 7</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[8]+' id="download" download>Download Program 8</a></li>\n' +
                        '  <li class="list-group-item"><a href='+jsonData[9]+' id="download" download>Download Program 9</a></li>\n' +
                        '</ul>' +
                        '</div>' +
                        '</div>');
                }
        ...
        $(document).on("click", '#btnPad', function(event) {
            ...
            request = $.ajax({
                ...
                .done(function (result, textStatus, jqXHR){
                    ...
                    $("#pps").empty();
                    $('#pad-pps').css('display', '');
                    $("#pps").html('<h5>PPS is:'+ jsonData.pps+'</h5></br><h5>Program will be used is: '+ jsonData.programNumber+'</h5>');
        ...
        $(document).on("click", '#btnRearrange', function(event) {
            ...
            request = $.ajax({
                ...
                .done(function (result, textStatus, jqXHR){
                    ...
                    $("#rearrange").html('<h5>P-text rearranging by the point ' + jsonData+ ' successfully finished.</h5>');
        ...
        $(document).on("click", '#btnXor', function(event) {
            ...
            request = $.ajax({
                ...
                .done(function (result, textStatus, jqXHR){
                    ...
                    $("#xor").html('<h5>Was used ' + jsonData+ ' .</h5>');
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", '#btnPps', function(event) {
            ...
            // post to the backend script in ajax mode
            var serializedData = 'action=insert_pps';
            ...
            request = $.ajax({
                ...
                .done(function (result, textStatus, jqXHR){
                    ...
                    $("#pps_info").html('<h5>PPS ' + jsonData.pps+ ' .</h5></br>'+
                        '<h5>Insertion Point ' + jsonData.ppsPoint+ ' .</h5>');

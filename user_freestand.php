...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="py-5 text-center">
            <h2 style="color: #007bff">XOR or XNOR two files </h2>
            <p class="lead">Below is a form for generating trully randomized files.</p>
        </div>
            ...
            <div class="col-md-8 order-md-1">
                <form enctype="multipart/form-data" id="xorForm" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="file-one" name="file-one" required />
                        <label for="file">File Two</label>
                        <input type="file" class="form-control" id="file-two" name="file-two" required />
                    </div>
        ...
        $("#xorForm").on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#freestand").html('<a href="userfiles/genfile.txt" id="download" download>Download generated file</a>');
                }
            });
        });
    });
